...
describe('Users', async () => {
	...
	describe('Sign up with google', async () => {
		...
		it('Should set status code 200 when user is valid', async () => {
			...
			sandbox.assert.calledOnceWithExactly(Model.prototype.create, { ...fakeUser, provider: 'google' });
